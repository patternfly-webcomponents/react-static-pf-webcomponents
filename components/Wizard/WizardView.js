...
class WizardView extends React.Component {
  ...
  componentDidMount() {
    this.wizard = new Wizard('#complete');
  }
        ...
        <div className="modal-dialog modal-lg wizard-pf">
          <div className="modal-content">
            <div className="modal-header">
              <button type="button" className="close wizard-pf-dismiss"
                ...
                <div className="wizard-pf-main">
                  ...
                  <div className="wizard-pf-contents hidden">
                    <form className="form-horizontal">
                      ...
                      <div className="form-group">
                        <label className="col-sm-2 control-label"
                          htmlFor="descriptionInput-markup">Description (Optional)</label>
                        <div className="col-sm-10">
                          <textarea data-id="descriptionInput-markup"
                  ...
                  <div className="wizard-pf-contents hidden">
                    <form className="form-horizontal">
                      <div className="form-group required">
                        <label className="col-sm-2 control-label"
                          htmlFor="lorem">Lorem ipsum</label>
                        <div className="col-sm-10">
                      ...
                      <div className="form-group">
                        <label className="col-sm-2 control-label"
                          htmlFor="dolor">Dolor (Optional)</label>
                        <div className="col-sm-10">
                  ...
                  <div className="wizard-pf-contents hidden">
                    <form className="form-horizontal">
                      ...
                      <div className="form-group">
                        <label className="col-sm-2 control-label"
                          htmlFor="fermentum">Fermentum</label>
                        <div className="col-sm-10">
                  ...
                  <div className="wizard-pf-contents hidden">
                    <form className="form-horizontal">
                      <div className="form-group required">
                        <label className="col-sm-2 control-label"
                          htmlFor="consectetur">Consectetur</label>
                        <div className="col-sm-10">
                      ...
                      <div className="form-group">
                        <label className="col-sm-2 control-label"
                          htmlFor="adipiscing">Adipiscing</label>
                        <div className="col-sm-10">
            ...
            <div className="modal-footer wizard-pf-footer">
              <button type="button" className="btn btn-default btn-cancel wizard-pf-cancel wizard-pf-dismiss"
              ...
              <button type="button" className="btn btn-primary hidden wizard-pf-close wizard-pf-dismiss"
