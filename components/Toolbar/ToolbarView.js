        ...
        <div className="col-sm-12">
          <form className="toolbar-pf-actions">
                ...
                <div className="input-group-btn">
                  ...
                  <ul className="dropdown-menu">
                    {this.props.columns.map((column,i) =>
                      <li key={i}><a href="#" onClick={(e) => {this.handleFilterClick(e, column);}}>{column.displayName}</a></li>
                    )}
                  </ul>
                </div>
            ...
            <div className="form-group">
              ...
              <button className="btn btn-default" type="button" onClick={this.props.defaultAction.action }>{this.props.defaultAction.label}</button>
              }
              {this.props.primaryAction &&
              <button className="btn btn-default" type="button" onClick={this.props.primaryAction.action }>{this.props.primaryAction.label}</button>
              }
