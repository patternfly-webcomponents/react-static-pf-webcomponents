...
describe('Home Page test suite', () => {
  it('should show the pf-alert component when showSuccess is true', () => {
    ...
    expect(wrapper.find('pf-alert').html())
      .toEqual('<pf-alert type="success" persistent="true">'
        + '<strong>Great job!</strong><!-- react-text: 138 --> This is really working out great for us.<!-- /react-text -->'
        + '</pf-alert>');
  });
